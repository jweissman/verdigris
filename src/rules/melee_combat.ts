    ...
    if (batcher) {
      ...
      batcher.register(
        ...
        (a: Unit, b: Unit) => {
          ...
          if (this.engagements.has(a.id) || this.engagements.has(b.id))
            return false;
          if (
            a.tags?.includes("noncombatant") ||
            b.tags?.includes("noncombatant")
          )
            return false;
          if (a.tags?.includes("effect") || b.tags?.includes("effect"))
            return false; // Don't attack effect units
