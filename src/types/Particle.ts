...
export interface Particle {
  ...
  type?: 'leaf' | 'rain' | 'debris' | 'snow' | 'lightning' | 'lightning_branch' | 'electric_spark' | 'thunder_ring' | 'ozone' | 'storm_cloud' | 'power_surge' | 'energy' | 'heat_shimmer' | 'heat_stress' | 'grapple_line' | 'pin' | 'sand' | 'tame' | 'calm' | 'entangle' | 'heal' | 'magic' | 'sand_burst' | 'pain' | 'freeze_impact' | 'reinforce' | 'hack'; // Different particle types
