...
export default class FontAtlas {
  ...
  private loadFonts() {
    ...
    this.largeFontImage.onload = () => {
      console.debug(`Large font loaded: ${this.largeFontImage!.width}x${this.largeFontImage!.height}`);
    };
    ...
    this.tinyFontImage.onload = () => {
      console.debug(`Tiny font loaded: ${this.tinyFontImage!.width}x${this.tinyFontImage!.height}`);
    };
