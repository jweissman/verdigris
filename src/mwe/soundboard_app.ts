...
class SoundboardUI {
  ...
  private saveEdit(): void {
    ...
    const waveform =
      (editWave?.value as "sine" | "square" | "triangle" | "sawtooth") ||
      "sine";
    ...
    const success = this.soundboard.setPad(
      this.editingPad,
      name,
      frequencies,
      duration,
    ...
    if (statusEl) {
      ...
      setTimeout(() => {
        statusEl.textContent =
          "Ready • Click pads to play • Right-click to edit";
      }, 2000);
    }
  }
}
