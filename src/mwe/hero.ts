...
if (typeof window !== "undefined") {
  ...
  if (canvas) {
    ...
    if (!playerControl) {
      console.error("PlayerControl rule not found in simulator!");
    } else {
      console.log("PlayerControl found:", playerControl);
    }
    ...
    document.addEventListener("keydown", (e) => {
      ...
      if (e.key === "i" || e.key === "I") {
        ...
        console.log("Sey key ", e.key, " for player ctrl ", playerControl)
